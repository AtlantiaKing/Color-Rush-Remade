...
void utils::SetColor(Color color)
{
	...
	case Color::yellow:
		...
		break;
	case Color::lime:
		utils::SetColor(Color4f{ 0.0f, 1.0f, 0.5f, 1.0f });
		break;
	case Color::purple:
		utils::SetColor(Color4f{ 0.75f, 0.0f, 1.0f, 1.0f });
		break;
	case Color::brown:
		utils::SetColor(Color4f{ 0.5f, 0.25f, 0.0f, 1.0f });
		break;
	}
}

Color4f utils::GetColor(Color color)
{
	switch (color)
	{
	case Color::red:
	...
	case Color::yellow:
		...
		break;
	case Color::lime:
		return Color4f{ 0.0f, 1.0f, 0.5f, 1.0f };
		break;
	case Color::purple:
		return Color4f{ 0.75f, 0.0f, 1.0f, 1.0f };
		break;
	case Color::brown:
		return Color4f{ 0.5f, 0.25f, 0.0f, 1.0f };
		break;
	}
