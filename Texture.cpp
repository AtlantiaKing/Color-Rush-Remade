...
void Texture::Draw( const Point2f& dstBottomLeft, const Rectf& srcRect, bool changeColor, Color color) const
{
	...
	else
	{
		...
		Draw( dstRect, srcRect, changeColor, color);
	}
}

void Texture::Draw(const Rectf& dstRect, const Rectf& srcRect, bool changeColor, Color color) const
{
	const float epsilon{ 0.001f };
	if ( !m_CreationOk )
	{
...
void Texture::Draw(const Rectf& dstRect) const
{
	const Rectf srcRect
	{
		0.0f,
