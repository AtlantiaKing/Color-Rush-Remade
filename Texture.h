...
public:
	...
	void Draw(const Point2f& dstBottomLeft, const Rectf& srcRect, bool changeColor, Color color = Color::red) const;
	void Draw( const Rectf& dstRect, const Rectf& srcRect, bool changeColor, Color color = Color::red) const;
